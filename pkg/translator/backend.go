...
func fetchBackend(namespace string, backendRef gatewayv1.BackendRef, backendLister agenticlisters.BackendLister, serviceLister corev1listers.ServiceLister, referenceGrantLister gatewaylistersv1beta1.ReferenceGrantLister) (*agenticv0alpha0.Backend, error) {
...
func convertBackendToCluster(backend *agenticv0alpha0.Backend) (*clusterv3.Cluster, error) {
...
func buildClustersFromBackends(backends []*agenticv0alpha0.Backend) ([]*clusterv3.Cluster, error) {

...
func rbacConfigFromAccessPolicy(accessPolicyLister agenticlisters.AccessPolicyLister, backend *agenticv0alpha0.Backend) (*rbacv3.RBAC, error) {
...
func findAccessPolicyForBackend(backend *agenticv0alpha0.Backend, accessPolicyLister agenticlisters.AccessPolicyLister) (*agenticv0alpha0.AccessPolicy, error) {
	// List all AccessPolicies in the Backend's namespace.
	allAccessPolicies, err := accessPolicyLister.AccessPolicies(backend.Namespace).List(labels.Everything())
	if err != nil {
...
func translateAccessPolicyToRBAC(accessPolicy *agenticv0alpha0.AccessPolicy, backend *agenticv0alpha0.Backend) map[string]*rbacconfigv3.Policy {

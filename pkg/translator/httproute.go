...
) ([]*routev3.Route, []*agenticv0alpha0.Backend, metav1.Condition) {

	var envoyRoutes []*routev3.Route
	var allValidBackends []*agenticv0alpha0.Backend
...
func buildHTTPRouteAction(namespace string,
	...
	referenceGrantLister gatewaylistersv1beta1.ReferenceGrantLister,
	accessPolicyLister agenticlisters.AccessPolicyLister,
	backendLister agenticlisters.BackendLister) (*routev3.RouteAction, []*agenticv0alpha0.Backend, error) {

	weightedClusters := &routev3.WeightedCluster{}
	var validBackends []*agenticv0alpha0.Backend
...
func buildPerClusterRBACFilterConfig(accessPolicyLister agenticlisters.AccessPolicyLister, backend *agenticv0alpha0.Backend) (map[string]*anypb.Any, error) {

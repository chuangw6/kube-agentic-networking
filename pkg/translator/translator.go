...
const (
	defaultSocketAddress = "127.0.0.1"
)
...
func (t *Translator) buildEnvoyResourcesForGateway(gateway *gatewayv1.Gateway) (
		...
		for _, listener := range listeners {
			...
			case gatewayv1.HTTPProtocolType, gatewayv1.HTTPSProtocolType:
				...
				for _, httpRoute := range routesByListener[listener.Name] {
					routes, allValidBackends, resolvedRefsCondition := translateHTTPRouteToEnvoyRoutes(httpRoute, t.serviceLister, t.referenceGrantLister, t.authPolicyLister, t.backendLister)
	...
	return map[resourcev3.Type][]envoyproxytypes.Resource{
			...
			// resourcev3.RouteType:    {}, // No separate RouteConfiguration resources needed for inline config.

		...
		for _, listener := range listeners {
			...
			case gatewayv1.HTTPProtocolType, gatewayv1.HTTPSProtocolType:
				...
				for _, httpRoute := range routesByListener[listener.Name] {
					routes, allValidBackends, resolvedRefsCondition := translateHTTPRouteToEnvoyRoutes(httpRoute, t.serviceLister, t.referenceGrantLister, t.accessPolicyLister, t.backendLister)

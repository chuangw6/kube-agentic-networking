...
type AccessPolicyInformer interface {
	...
	Lister() apiv0alpha0.AccessPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgenticV0alpha0().AccessPolicies(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV0alpha0().AccessPolicies(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV0alpha0().AccessPolicies(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV0alpha0().AccessPolicies(namespace).Watch(ctx, options)
			},
		},
		&kubeagenticnetworkingapiv0alpha0.AccessPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accessPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubeagenticnetworkingapiv0alpha0.AccessPolicy{}, f.defaultInformer)
}

func (f *accessPolicyInformer) Lister() apiv0alpha0.AccessPolicyLister {
	return apiv0alpha0.NewAccessPolicyLister(f.Informer().GetIndexer())
}
